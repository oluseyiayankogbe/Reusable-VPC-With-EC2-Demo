...
resource "aws_subnet" "public-subnet-1" {
  ...
  tags = {
    Name = "${var.descriptor1}-public-subnet-1"
  }
}
...
resource "aws_subnet" "public-subnet-2" {
  ...
  tags = {
    Name = "${var.descriptor1}-public-subnet-2"
  }
}
...
resource "aws_subnet" "private-subnet-1" {
  ...
  tags = {
    Name = "${var.descriptor2}-private-subnet-1"
  }
}
...
resource "aws_subnet" "private-subnet-2" {
  ...
  tags = {
    Name = "${var.descriptor2}-private-subnet-2"
  }
}
